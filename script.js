$(document).ready(function() {
    ...
    for (songs in songSet1) {
        $('.sheet-box').append(`<div class ="row sheet-row"><div class="col-sm-2"></div><div class="col-sm-8"><div class="sheet-placeholder"> <img src="${songSet1[songs]}" width="100%"></div></div><div class="col-sm-2"></div></div>`);    
    }
